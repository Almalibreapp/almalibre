...
import { 
  ...
  controlDeshielo,
  controlDescongelacionOn,
  controlDescongelacionOff,
...
const controlActions: ControlAction[] = [
  ...
  {
    id: 'descongelacion-on',
    label: 'Activar Descongelación',
    description: 'Activa el ciclo de descongelación de la máquina',
    icon: Droplets,
    color: 'text-orange-600',
    bgColor: 'bg-orange-100 hover:bg-orange-200',
    needsConfirmation: true,
    confirmMessage: '¿Activar descongelación? Solo usar para mantenimiento',
    action: controlDescongelacionOn,
  },
  {
    id: 'descongelacion-off',
    label: 'Desactivar Descongelación',
    description: 'Desactiva el ciclo de descongelación',
    icon: ThermometerSnowflake,
    color: 'text-blue-600',
    bgColor: 'bg-blue-100 hover:bg-blue-200',
    needsConfirmation: true,
    confirmMessage: '¿Desactivar descongelación de la máquina?',
    action: controlDescongelacionOff,
  },
  {
    id: 'reanudar',
